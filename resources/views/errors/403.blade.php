...
<main class="flex flex-col justify-center items-center" style="height: 100%; background: #D9D9D9;">
    <div class="text-center"
        ...
        <h1 class="mt-4 text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl"
            style="padding: 1em; color: #031945;">{{ __('main.page_forbidden_error_title') }}</h1>
        <p class="mt-6 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8"
           style="color: #031945; padding: 2em;">{{ __('main.page_forbidden_error_intro') }}</p>
        <p class="mt-6 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8"
           style="color: #031945; padding: 2em;">{{ __('main.page_forbidden_error_admin_contact') }}</p>
        <div class="mt-10 flex items-center justify-center gap-x-6" style="background: #031945;
            ...
            <a href="{{ url()->previous() }}"
               ...
               style="text-decoration: none;
                      font-size: 1em;
                      color: #D9D9D9;"
            >{{ __('main.page_forbidden_error_button') }}</a>
        </div>
    </div>
</main>
</body>
